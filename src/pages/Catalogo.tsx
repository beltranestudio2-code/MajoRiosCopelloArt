  ...
  return (
    <div className="min-h-screen bg-paper">
      <header className="border-b border-ink/10 px-6 py-10 text-center">
        <h1 className="font-display text-5xl font-semibold tracking-tight text-ink">Majo Rioscopello</h1>
        <p className="mt-2 text-ink/60">Obras originales · @majorioscopello_art</p>
        <a
